<?php 
    ...
    switch($accion){
        ...
        case 1:
            ...
            header("Location:comments_r.php");
            break;
        ...
        case 2:
            ...
            comment_content = ?, comment_status = ? WHERE comment_id = ?", array($comment_id, $comment_post_id, 
            $comment_author, $comment_email, $comment_content, $comment_status ,  $id));
            $insertId = $db->lastInsertId();
            $db->closeConnection();
