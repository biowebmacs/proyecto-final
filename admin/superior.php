      ...
      <nav role="navigation" class="navbar navbar-custom">
        <div class="container-fluid">
          ...
          <div class="navbar-header">
            <a href="#" class="navbar-brand ">MACS</a>
          </div>
          ...
          <div id="bs-content-row-navbar-collapse-5" class="collapse navbar-collapse">
            <ul class="nav navbar-nav navbar-right">
              ...
              <li class="dropdown">
                <a data-toggle="dropdown" class="dropdown-toggle" href="#" style="color:#67b6eb;"><?php echo $_SESSION['username']; ?><b class="caret"></b></a>
                <ul role="menu" class="dropdown-menu">
                  <li class="dropdown-header"><i class="glyphicon glyphicon-cog"></i> Configuraciòn</li>
                  <li class="active"><a href="#" style="color:#67b6eb;"><i class="glyphicon glyphicon-wrench"></i> Preferencias</a></li>
                  <li></li>
